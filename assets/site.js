...
window.RK.initServices=function(root){
  ...
  const S={
    laser:{n:'01',img:'assets/service-laser.jpg',alt:'טיפול הסרת שיער בלייזר עם מכשיר InMode',
    ...
    face:{n:'03',img:'assets/service-plasma.jpg',alt:'לפני ואחרי — שיפור מרקם וגוון עור הפנים',
    ...
    more:{n:'04',img:'assets/inmode-gear.jpg',alt:'מכשור InMode ומשקפי מגן בקליניקה',
